  ...
  <div class="container-fluid">
    ...
    <div class="bg_wh mt20">
        ...
        <?
          if($this->site_code !=""){
        ?>
        <input type="text" style="display:none" id="site_code" name="site_code" value="<?=$result->site_code?>">
        <?}?>
            ...
            <?}?>
                    ...
                    <input class="form-control" type="text" name="title" id="banner_title" value="<?=$result->title?>">
							...
							<!-- <tr>
								<th>배너 내용</th>
								<td colspan=3>
                    <input class="form-control" name="contents" id="contents" value="<?=$result->contents?>">
                </td>
							</tr> -->
							<tr>
								<th>링크 URL</th>
								<td colspan=3>
                    <input class="form-control" type="url" name="link_url" id="link_url" value="<?=$result->link_url?>">
                </td>
							</tr>
              <tr>
                <th>노출 상태</th>
                <td colspan=3>
                  <div class="toggle_set">
                    <select name="state" id="state" class="form-control w_auto">
                      <option value="1" <?php if($result->state =="1") echo 'selected'; ?>>활성화</option>
                      <option value="0" <?php if($result->state =="0") echo 'selected'; ?>>비활성화</option>
                    </select>
                  </div>
                </td>
              </tr>
                ...
                <td style="vertical-align:top;"  colspan=3>
                  <div class="view_img mg_btm_20">
                    <ul class="img_hz" id="img">
                      ...
                      if($result->img_path != ""){
                      ?>
                        <li id="id_file_<?=$file_cnt?>" style="display:inline-block;">
