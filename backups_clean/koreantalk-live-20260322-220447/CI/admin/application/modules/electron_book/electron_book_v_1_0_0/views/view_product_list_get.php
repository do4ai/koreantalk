<div class="row table_title">
  ...
  <p class="col-lg-8 text-right"> &nbsp;&nbsp;
    ...
    <a href="/<?=mapping('electron_book')?>/product_reg" class="btn btn-success">등록</a>
  </p>
</div>
...
<table class="table table-bordered tr_link">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="/<?=mapping('electron_book')?>/product_detail?electron_book_idx=<?=$row->electron_book_idx?>&history_data=<?=$history_data?>"><?=$row->product_name?></a>
      </td>
