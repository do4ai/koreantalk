...
//대시보드
  public function member_info_list(){ 
	  ...
	  $page_size = PAGESIZE ;
		...
		$result_list_count = 77; // FAQ 리스트 카운트 가져오기
    ...
    $this->_view(mapping('member_info').'/view_member_info_list',$response);
...
//대시보드
  public function member_info_reg(){ 
    $this->_view(mapping('member_info').'/view_member_info_reg');
