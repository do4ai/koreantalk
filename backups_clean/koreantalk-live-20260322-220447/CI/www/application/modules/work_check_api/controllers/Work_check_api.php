...
class Work_check_api extends MY_Controller
{
  ...
  //업무 완료 체크 등록
	function work_check_reg_in(){
		...
		$api_url = 'http://p.admin.bandal.or.kr/work_check/work_check_reg_in';
  ...
  //업무 완료 유무
	function work_check_state(){
		...
		$api_url = 'http://p.admin.bandal.or.kr/work_check/work_check_state';
		$userAgent=$_SERVER['HTTP_USER_AGENT'];
	...
	function work_memo_list(){
		...
		$api_url = 'http://p.admin.bandal.or.kr/work_check/work_memo_list';
		$userAgent=$_SERVER['HTTP_USER_AGENT'];
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_USERAGENT, $userAgent);
		curl_setopt($ch, CURLOPT_HTTPAUTH, CURLAUTH_BASIC);
	...
	function memo_add_reg_in(){
		...
		$api_url = 'http://p.admin.bandal.or.kr/work_check/memo_add_reg_in';
		$userAgent=$_SERVER['HTTP_USER_AGENT'];
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_USERAGENT, $userAgent);
		curl_setopt($ch, CURLOPT_HTTPAUTH, CURLAUTH_BASIC);
	...
	function work_check_memo_del(){
		...
		$api_url = 'http://p.admin.bandal.or.kr/work_check/work_check_memo_del';
		$userAgent=$_SERVER['HTTP_USER_AGENT'];
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_USERAGENT, $userAgent);
		curl_setopt($ch, CURLOPT_HTTPAUTH, CURLAUTH_BASIC);
	...
	public function login_action(){
		...
		$api_url = 'http://p.admin.bandal.or.kr/work_check/login_action';
		$userAgent=$_SERVER['HTTP_USER_AGENT'];
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_USERAGENT, $userAgent);
		curl_setopt($ch, CURLOPT_HTTPAUTH, CURLAUTH_BASIC);
