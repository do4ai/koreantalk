...
function work_check_login_check(){
  ...
  $.ajax({
    url      : "/<?=$this->current_lang?>/work_check_api/login_action",
    type     : 'POST',
    dataType : 'json',
    async    : true,
    data     : form_data,
...
function work_memo_status_up (){
  ...
  $.ajax({
    url: "/<?=$this->current_lang?>/work_check_api/work_state_check_memo_xy_up",
    type: 'POST',
    dataType: 'json',
...
var memo_add_reg = function(){
  ...
  $.ajax({
    url: "/<?=$this->current_lang?>/work_check_api/memo_add_reg_in",
    type: "post",
    data : {
            "new_memo":new_memo,
...
var work_memo_list = function(){
  var work_check_idx = $("#work_check_idx").val();
  $.ajax({
    url: "/<?=$this->current_lang?>/work_check_api/work_memo_list",
    type: "post",
    data : {
            "work_check_idx":work_check_idx
           },
...
function work_meme_del(work_check_memo_idx){
  ...
  $.ajax({
    url: "/<?=$this->current_lang?>/work_check_api/work_check_memo_del",
    type: "post",
...
var work_check_save = function(){
  ...
  $.ajax({
    url: "/<?=$this->current_lang?>/work_check_api/work_check_reg_in",
    type: "post",
    data : {"url":url,
            "full_url":full_url,
            "state":state,
...
var work_check_state = function(save_state) {
  ...
  if(save_state ==1){
	...
	$.ajax({
		url: "/<?=$this->current_lang?>/work_check_api/work_check_state",
		type: 'POST',
		dataType: 'json',
    data : {"url":url},
		async: true,
...
function work_check_view(){
  window.open("http://p.admin.bandal.or.kr/work_check/work_check_list?project_idx=<?=PROJECT_IDX?>&url_site_type=<?=$url_site_type[0]?>", "work_check_view");
}
</script>
