<div class="body  row">
  <div class="inner_wrap">
    <div class="sub_title"><?=lang('lang_10280','서점')?></div> 
    <div class="wrap_search">
      <input type="text" placeholder='<?=lang('lang_10281','책 제목, 설명을 입력해 주세요.')?>' id="s_text" name="s_text">
...
<script>
  ...
  function default_list_get(page_num){
    ...
    $.ajax({
      url      : "/<?=$this->current_lang?>/<?=mapping('product')?>/product_list_get",
      type     : "POST",
      dataType : "html",
      async    : true,
      data     : formData,
