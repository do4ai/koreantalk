...
class Product_v_1_0_0 extends MY_Controller{
  ...
  public function product_list_get(){
		...
		$result_list = $this->model_product->product_list_get($data); // 리스트 가져오기
		$result_list_count = $this->model_product->product_list_count($data); //  리스트 카운트 가져오기
  ...
  public function product_detail(){
		...
		$rt = $this->model_product->product_detail($data); // 리스트 가져오기
